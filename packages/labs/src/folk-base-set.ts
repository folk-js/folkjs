import { FolkElement, type ClientRectObserverEntry } from '@folkjs/canvas';
import { css, property, state, type CSSResultGroup, type PropertyValues } from '@folkjs/canvas/reactive-element';
