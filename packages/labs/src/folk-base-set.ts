import { FolkElement, type ClientRectObserverEntry } from '@folkjs/lib';
import { css, property, state, type CSSResultGroup, type PropertyValues } from '@folkjs/lib/reactive-element';
