import { type ClientRectObserverEntry, FolkElement, parseVertex } from '@folkjs/lib';
import { css, type CSSResultGroup, property, type PropertyValues, state } from '@folkjs/lib/reactive-element';
